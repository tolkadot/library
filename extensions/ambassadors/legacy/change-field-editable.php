<?php
/**
 * NOTE: This is a legacy example. If you are using Ambassadors 2+, use
 * the following code snippet instead:
 *
 * @see https://github.com/Charitable/library/blob/master/extensions/ambassadors/campaign-submission-form/change-field-editable.php
 */
